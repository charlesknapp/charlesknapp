...
<p><strong>I love creating and contributing towards web applications that empower other people to build amazing things.<br> &nbsp; <img src='https://random-memer.herokuapp.com/' height="150" width="auto" title="Meme" alt="Please refresh the page if the meme doesn't show up." align="right">
