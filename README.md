...
<p><strong>I love creating and contributing towards web applications that empower other people to build amazing things.<br>From full-stack development for your businesses and projects to engineering your game's soundtracks & audio soundscapes,<br>my tasks are completed with detail and efficiency.</strong> <img src='https://random-memer.herokuapp.com/' height="250" width="auto" title="Meme" alt="Please refresh the page if the meme doesn't show up." align="right"></p>
